<template>
  <div class="login-container">
    ...
    >
      <h3 class="title">
        <span>
          <img style="width:48px;margin-bottom:-5px;margin-right:2px" src="../../assets/logo.png" />
        </span>CRAWLER
      </h3>
      ...
      <div v-if="isShowMobileWarning" class="mobile-warning">
        <el-alert
          type="error"
          :closable="false"
        >{{$t('You are running on a mobile device, which is not optimized yet. Please try with a laptop or desktop.')}}</el-alert>
      </div>
    </el-form>
  </div>
</template>
